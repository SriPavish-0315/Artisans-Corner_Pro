    ...
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="bg-white rounded-3xl p-8 border border-amber-100 shadow-xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-gray-500">Sign up and save your account permanently in the database</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Admin Verification Code Input Field for Admin Role */}
          {role === 'admin' && (
            <div className="bg-purple-50 p-4 rounded-2xl border border-purple-200 space-y-2 animate-fadeIn">
              ...
              <p className="text-[10px] text-purple-700 font-semibold">
                Authorization required. Default master admin passcode is <code className="bg-purple-200 px-1 py-0.5 rounded font-bold">shop_@</code>
              </p>
            </div>
          )}

          {/* Admin Delivery Passcode Input Field for Door Delivery Role */}
          {role === 'delivery' && (
            <div className="bg-blue-50 p-4 rounded-2xl border border-blue-200 space-y-2 animate-fadeIn">
              ...
              <p className="text-[10px] text-blue-700 font-semibold">
                Admin authorization required. Admin assigned Door Delivery passcode is <code className="bg-blue-200 px-1 py-0.5 rounded font-bold">delivery_@</code>
              </p>
            </div>
          )}
